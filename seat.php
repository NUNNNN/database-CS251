...
.buy {
  ...
  <select id="movie">
    <option value="1500">Zone A (THB. 1500)</option>
    <option value="1200">Zone B  (THB. 1200)</option>
    <option value="1000">Zone C  (THB. 1000)</option>
    <option value="900">Zone D  (THB. 900)</option>
  </select>
  ...
  <div class="container">
    ...
    <p class="text">
      You have selected <span id="count">0</span> seats for the total price of THB. <span id="total">0</span>
    </p>
